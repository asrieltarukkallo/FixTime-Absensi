<?php
/**
 * TEMPLATE ABSENSI UNIVERSAL DENGAN VALIDASI GPS
 * 
 * Untuk menggunakan template ini:
 * 1. Copy file ini
 * 2. Ganti nilai variabel berikut sesuai jenis absensi:
 *    - $jenis_absen: 'Jam Dinas', 'Poliklinik', 'Operasi', 'Visite'
 *    - $page_title: Judul halaman
 *    - $icon_class: Icon Bootstrap untuk header
 */
...
// ========== KONFIGURASI PER JENIS ABSENSI ==========
// GANTI SESUAI KEBUTUHAN
$jenis_absen = 'Operasi'; // Options: 'Jam Dinas', 'Poliklinik', 'Operasi', 'Visite'
$page_title = 'Absensi Operasi';
